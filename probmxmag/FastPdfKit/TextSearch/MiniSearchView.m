...
#import "Stuff.h"
//was #import "DocumentViewController.h"
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
		...
		UIBarButtonItem *doneItem = [[UIBarButtonItem alloc] initWithTitle:@"Отмена" style:UIBarButtonItemStyleDone target:self action:@selector(actionCancel:)];
		
        UIBarButtonItem *fullItem = [[UIBarButtonItem alloc] initWithTitle:@"Поиск" style:UIBarButtonItemStyleBordered target:self action:@selector(actionFull:)];
