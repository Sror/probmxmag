...
#define PAGE_NUM_LABEL_TEXT(x,y) [NSString stringWithFormat:@"Стр. %d из %d",(x),(y)]
...
//  UIBarButtonItem * bbItem = nil; //! Not used
...
-(IBAction) actionOutline:(id)sender {
	...
	if (currentReusableView != FPK_REUSABLE_VIEW_OUTLINE) {
        ...
        //was outlineVC = [[OutlineViewController alloc]initWithNibName:@"OutlineView" bundle:MF_BUNDLED_BUNDLE(@"FPKReaderBundle")];
		...
		//deprecated	[self presentModalViewController:outlineVC animated:YES];
...
-(void)presentFullSearchView {
	...
	//deprecated	[self presentModalViewController:(UIViewController *)controller animated:YES];
...
-(IBAction) actionDismiss:(id)sender {
	...
	if(self.dismissBlock) {
        ...
        if ([self respondsToSelector:@selector(presentingViewController)]) {
           ...
           //deprecated [[self parentViewController] dismissModalViewControllerAnimated:YES];
...
-(IBAction) actionPageSliderSlided:(id)sender {
	...
	NSUInteger pageNumber = [number unsignedIntValue]; //! not used
	*/
	// Update the label.
...
-(void)showWebView:(NSString *)url local:(BOOL)isLocal{
	...
	//deprecated [self presentModalViewController:webBrowser animated:YES];
...
-(void)presentTextDisplayViewControllerForPage:(NSUInteger)page {
  ...
  //deprecated  [self presentModalViewController:controller animated:YES];
...
-(void)prepareToolbar {
	...
	if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) { // Ipad.
		...
		*/
		...
		//deprecated aLabel.textAlignment = UITextAlignmentLeft;
